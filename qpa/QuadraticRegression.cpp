...
QuadraticRegression::QuadraticRegression(std::vector< std::vector<double> > &points, std::vector< double > &values)
{
...
void QuadraticRegression::setData(std::vector< std::vector<double> > &points, std::vector< double > &values)
{
...
double QuadraticRegression::evaluate(std::vector<double> &point)
{
    double v = c[0];
    int r = 1;
